...
class HudProfile {
  ...
  factory HudProfile.fromJson(Map<String, dynamic> j) => HudProfile(
        ...
        bindings: (j['bindings'] as Map).map((k, v) => MapEntry(
            k, (v as List).map((e) => KeyBinding.fromJson(e)).toList())),
  ...
  static HudProfile get defaults {
    ...
    final buttons = [
      ...
      HudBtn(
          id: 'b_ability1', bindId: 'ability1', x: 0.82, y: 0.18, size: 0.088),
      HudBtn(
          id: 'b_ability2', bindId: 'ability2', x: 0.91, y: 0.18, size: 0.082),
      HudBtn(
          id: 'b_ultimate', bindId: 'ultimate', x: 0.82, y: 0.32, size: 0.080),
      HudBtn(
          id: 'b_ability3', bindId: 'ability3', x: 0.91, y: 0.32, size: 0.076),
      HudBtn(
          id: 'b_interact', bindId: 'interact', x: 0.97, y: 0.20, size: 0.075),
      HudBtn(
          id: 'b_quick_melee',
          bindId: 'quick_melee',
          x: 0.97,
