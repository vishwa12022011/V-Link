                  ...
                  Row(children: [
                    ...
                    if (binding.isHold)
                      Container(
                        ...
                        padding: const EdgeInsets.symmetric(horizontal: 5, vertical: 1),
                        color: T.red,
                        child: Text('HOLD', style: T.mono(7, color: Colors.white)),
                      ),
                  ]),
                ],
              )),
...
class _KeyChips extends StatelessWidget {
  ...
  const _KeyChips({required this.keys, required this.isHold, required this.accent});
          ...
          Padding(
            ...
            child: Row(children: [
              Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Text('REMAP: ${widget.binding.label.toUpperCase()}', style: T.orb(14)),
                const SizedBox(height: 2),
          ...
          Expanded(child: TabBarView(
            ...
            children: [
              ...
              SingleChildScrollView(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Text('BUTTON BEHAVIOUR', style: T.mono(9, color: T.grey)),
                  const SizedBox(height: 12),
                  ...
                  _OptionTile(
                    ...
                    label: 'Hold Mode',
                    sub: 'Holds all combo keys while toggled ON. Release on second tap.',
                    value: _isHold,
                  ...
                  _OptionTile(
                    ...
                    label: 'Toggle Mode',
                    sub: 'First tap activates, second tap deactivates (fires key once each time).',
                    value: _isToggle,
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: T.bg3, border: Border.all(color: T.border)),
                      child: Center(child: Text('CLEAR COMBO',
