  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(children: [
        // Weapon 1 – pistol
        const _WeaponSlot(
            icon: Icons.pest_control, label: '00/00', active: false),
        // Divider
        Container(width: 1, color: const Color(0x33FFFFFF)),
        // Weapon 2 – primary (active)
        const _WeaponSlot(icon: Icons.crop_16_9, label: '30/200', active: true),
        // Divider
        Container(width: 1, color: const Color(0x33FFFFFF)),
        // Weapon 3 – melee
        const _WeaponSlot(icon: Icons.edit, label: '∞', active: false),
        // Ammo mode
        Container(
          padding: const EdgeInsets.symmetric(horizontal: 8),
          child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
            const Icon(Icons.menu, color: Color(0xAAFFFFFF), size: 14),
