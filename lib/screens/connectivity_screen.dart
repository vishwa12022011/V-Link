      ...
      body: CustomScrollView(slivers: [
        ...
        SliverToBoxAdapter(
          ...
          child: Column(children: [
            ...
            if (_hidMode == _HidMode.bluetooth) const _BluetoothHidPanel(),
        ...
        child: Row(children: [
          ...
          Expanded(
            ...
            children: [
              Row(children: [
                Text(title,
                    style: T.raj(16, color: selected ? T.white : T.white)),
                if (badge != null) ...[
...
class _BluetoothHidPanel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return _SubPanel(children: [
      ...
      Text('OR CONNECT TO ESP32 VIA BLE',
      ...
      Row(children: [
        ...
        GestureDetector(
          ...
          child: Container(
            ...
            color:
                conn.isConnected && conn.mode == Transport.wifi ? T.bg3 : T.red,
            child: Text(
                conn.isConnected && conn.mode == Transport.wifi
                    ? 'DISCONNECT'
                    : 'CONNECT',
...
class _UsbHidPanelState extends State<_UsbHidPanel> {
  ...
  Widget build(BuildContext context) {
    ...
    return _SubPanel(children: [
      _PrerequisiteRow(
          label: 'USB Debugging Enabled', met: hid.usbDebuggingEnabled),
      const SizedBox(height: 8),
              ...
              child: Center(
                  child: _checking
                      ...
                      : Row(mainAxisSize: MainAxisSize.min, children: [
                          Icon(Icons.search,
                              size: 15,
                              color: prerequisitesMet ? T.grey : T.greyDim),
                          const SizedBox(width: 6),
                          Text('DETECT USB CONNECTION',
                              style: T.raj(13,
                                  color:
                                      prerequisitesMet ? T.grey : T.greyDim)),
                        ])),
            ),
          ),
        ),
  ...
  Widget build(BuildContext context) {
    ...
    return _SubPanel(children: [
      ...
      if (!webrtc.isConnected) ...[
        ...
        const SizedBox(height: 8),
        Center(
            child: Text('Run the V-Link WebRTC to get the QR code.',
                style: T.mono(9, color: T.greyDim),
                textAlign: TextAlign.center)),
      ] else ...[
        GestureDetector(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
                color: T.bg3, border: Border.all(color: T.border)),
            child: Center(
                child: Text('DISCONNECT', style: T.raj(14, color: T.grey))),
          ),
        ),
      ],
    ]);
  ...
  Widget build(BuildContext context) => Container(
        ...
        child: Row(children: [
          Container(
            ...
            child: Icon(icon ?? Icons.bluetooth,
