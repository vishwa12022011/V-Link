...
class _SearchAdd extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Padding(
    ...
    child: Row(children: [
      Expanded(child: Container(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            ...
            prefixIcon: const Icon(Icons.search, color: T.greyDim, size: 18),
          ),
        ),
      )),
      ...
      GestureDetector(
        onTap: onAdd,
        child: Container(width: 44, height: 44, color: T.red,
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Padding(
          ...
          child: Row(children: [
            ...
            if (isActive) VPill(label: 'ACTIVE', color: T.teal),
          ]),
        ),
...
class _SyncBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
    ...
    child: Row(children: [
      ...
      Expanded(child: Text('VAULT SYNCHRONIZED', style: T.mono(10, color: T.teal))),
      Container(
