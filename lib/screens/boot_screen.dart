              ...
              child: Column(
                  ...
                  children: [
                    ...
                    ShaderMask(
                      ...
                      child: Text(
                        'V-LINK',
                        style: T.orb(52, color: Colors.white).copyWith(
                            shadows: [
                              Shadow(
...
class _GridP extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    final p = Paint()
      ..color = T.bg3.withValues(alpha: 0.35)
      ..strokeWidth = 0.5;
  ...
  void paint(Canvas canvas, Size s) {
    ...
    canvas.drawCircle(
        ...
        Paint()
          ...
          ..color = T.red.withValues(alpha: 0.2)
          ..strokeWidth = 1.5);
    ...
    canvas.drawCircle(c, 5,
        Paint()..color = T.red.withValues(alpha: 0.5 + 0.5 * ((t * 2) % 1.0)));
  }
