...
class BootScreen extends StatefulWidget {
  ...
  @override
  State<BootScreen> createState() => _BootState();
}
  ...
  void initState() {
    ...
    _timer = Timer.periodic(const Duration(milliseconds: 28), (t) {
      ...
      setState(() {
        ...
        if (_progress >= 1.0) {
          t.cancel();
          Future.delayed(const Duration(milliseconds: 400), _go);
        }
      });
    });
  }
            ...
            child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  gradient: RadialGradient(
                      colors: [T.red.withOpacity(0.10), Colors.transparent]),
                )),
          ),
          Center(
                  ...
                  children: [
                    ...
                    ShaderMask(
                      ...
                      child: Text(
                        'V-LINK',
                        style: T
                            .orb(52, color: Colors.white)
                            .copyWith(shadows: [
                          Shadow(color: T.red.withOpacity(0.5), blurRadius: 24)
                        ]),
                      ),
                    ),
                    Text('TACTICAL  HUD',
                        style:
                            T.raj(12, color: T.red).copyWith(letterSpacing: 8)),
                    ...
                    Container(
                      ...
                      child: Column(
                          ...
                          children: [
                            ...
                            Text('> SCANNING FOR LOW ENERGY PERIPHERALS…',
                                style: T.mono(10)),
                            const SizedBox(height: 4),
                            Text('> TARGET: ESP32_HUD_CONTROLLER',
                                style: T.mono(10)),
                            const SizedBox(height: 4),
...
class _ScanRingState extends State<_ScanRing>
  ...
  Widget build(BuildContext context) => AnimatedBuilder(
        ...
        builder: (_, __) => CustomPaint(
            size: const Size(110, 110), painter: _RingP(_ctrl.value)),
      );
}
...
class _RingP extends CustomPainter {
  ...
  void paint(Canvas canvas, Size s) {
    ...
    canvas.drawCircle(
        c, 5, Paint()..color = T.red.withOpacity(0.5 + 0.5 * ((t * 2) % 1.0)));
  }

  @override
  bool shouldRepaint(_RingP o) => o.t != t;
}
