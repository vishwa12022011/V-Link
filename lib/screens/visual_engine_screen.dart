  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: CustomScrollView(slivers: [
        const SliverToBoxAdapter(child: VHeader(
          title: 'VISUAL ENGINE',
          ...
          children: List.generate(VisualModel.accents.length, (i) => GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                  color: vm.accentIndex == i ? Colors.white : Colors.transparent,
                  width: 2,
                ),
              ),
          ...
          child: Row(children: [
            ...
            Expanded(child: GestureDetector(
              onTap: () => ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(backgroundColor: T.red,
...
class _Sec extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Padding(
    ...
    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      const SizedBox(height: 12),
      Container(padding: const EdgeInsets.all(16), decoration: T.panel(), child: child),
    ]),
  );
}
