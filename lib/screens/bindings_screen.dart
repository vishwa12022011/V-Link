...
class BindingsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final sections = [
      ...
      ('UTILITY',            ['reload','buymenu','interact','gunswitch','knife','throw']),
    ...
    return Scaffold(
      ...
      body: CustomScrollView(slivers: [
        ...
        SliverToBoxAdapter(child: Container(
          ...
          child: Row(children: [
            const Icon(Icons.info_outline, color: T.grey, size: 16),
            const SizedBox(width: 10),
            Expanded(child: Text(
              'Tap any row to remap its key. Use + to build combos. '
